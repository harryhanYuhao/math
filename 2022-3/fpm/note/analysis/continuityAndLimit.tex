...
\theorem{ \emph{4.2.9}
	Let $f:[a,b] \rightarrow  \bb{R}$ be a continuous function. Image of $F$ is an interval.
}

\theorem{ \emph{4.2.10}
	Let $f:[a,b] \rightarrow  \bb{R}$ be a strictly increasing continuous function. If the image of $f$ is an interval, $f$ is continuous on $[a,b]$
}

\theorem{ \emph{4.2.11}
	If $f$ is a strictly increasing and continuous function, $f^{-1}$ is also one.
}
