...
Here are some properties immediately follows the definition of cyclic group.
\begin{enumerate}
...
\begin{proof}[Proof of Lagrange Theorem]
	...
	Consider the set: $\mathbb{D}_1=\{g_1s|s \in \mathbb{S}\}$. All elements in $\mathbb{D}_1$ has the following properties:
	\begin{enumerate}
	...
	Property III can be proved by contradiction. Assuming $\exists g_1s \in \mathbb{D}_1$ and $ g_1s \in \mathbb{S}.$ 
	...
	Construct the set $\mathbb{D}_2=\{g_ws|s \in \mathbb{S}\}$. All elements in $\mathbb{D}_2$ have properties I, II of $\mathbb{D}_1$, and a stronger III property: 
