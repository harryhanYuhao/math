...
\begin{table}
\centering 
\caption{Selected solutions for $y^p = x^2 + k$, while $k= r^2 d$ and $d$ is square free.
...
Notice that in all cases shown in the table, $h(\Qd) > \frac{\log d}{\log 3}.$}
