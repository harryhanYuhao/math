...
\begin{proof}
	...
	Let us consider $\d^{n+1}_i \sigma^n_i$ first.
	By definition 
	$$
...
The proof is exactly dual to that the previous proof of simplicial objects from comonads, by reversing all the arrows and the order of composition.
