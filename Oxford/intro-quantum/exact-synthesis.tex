...
In this section we present an algorithm for the exact synthesis of single qubit unitaries over the Clifford+T gate set, provided it is possible. 
The algorithm was proposed by Kliuchnikov et al. \cite{exact-clifford+t}.
...
We list the steps of the algorithm below for clarity.
