...
\subsection{Brief Introduction to Quantum Computation}
...
It turns out that any unitary operations on a single qubit is precisely the rotation on Bloch sphere.
