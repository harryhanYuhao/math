...
$\mathfrak{C}$ actually defines a functor from the category of simplicial sets to the category of simplicial categories \cite{lurie} 
\begin{align*}
...
Lurie \cite{lurie} showed the following proposition.
\begin{proposition}
